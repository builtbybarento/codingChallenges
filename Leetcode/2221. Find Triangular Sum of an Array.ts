...
//given integer array nums with digits between 0 and 9
...
//2. for each index i , assign the value of newNums[i] as  (nums[i]+nums[i+1]) % 10 
//3. replace the array nums with new nums
//4. repeat until 1 element remians
//ex. 12345 -> 3579 -> 826 -> 08 -> 8